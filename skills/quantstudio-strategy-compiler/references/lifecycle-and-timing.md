...
> Derived from docs/strategy-compiler/lifecycle-and-timing-contract.md @ 2026-07-22
...
当前引擎尚未实现该语义，`engine_semantics_version=0.1.0-legacy`。修复时必须提升版本并更新 Run Card/Changelog。
