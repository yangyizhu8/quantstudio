...
STRATEGY_ID = 'broken_board_reversal'
STRATEGY_NAME = '断板反包策略'
DESIGN_VERSION = '2.2'
...
def handle_data(context, data):
    ...
    mkt = get_history(INDEX_CODE, count=2, unit='1d', fields=['trade_date'],
    ...
    hist = get_history(g.universe, count=HIST_COUNT, unit='1d', fields=FIELDS,
                       fq='pre', include=False, is_dict=True)
    if not hist:
        return
