...
- **状态**：**BLOCKED(外部依赖)** —— 2026-09-23 用户裁定升级为近期解决事项；勘察已完成并**提前于 9/27 节点**交付
  （`docs/evidence/p1-cloud-etf-minutes-close-caliber-aprraisal-20260923.md`），
  结论＝**本项无法在客户端闭环**，需上游澄清与修复；**解除条件＝上游数据服务方响应**
  （请求件 `docs/p1-upstream-clarification-request-design.md`，R1~R7 获答复即部分解除、
  口径确认后进入消费链复核、修复落地后由对拍扫描器验证收敛）。
