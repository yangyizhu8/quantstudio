# PTrade-target dual-end mirror of quantstudio/backtest/strategies/sw_industry_etf_rotation_8f__candidate_quantstudio.py
# Bear-market logic (RECOVERY_DAYS / S3_BEAR_FRAC / _bear_signal_s1s2s3 / trigger / rebalance bear branch)
# is byte-consistent with the QuantStudio candidate (dual-end invariant). Platform headers only.
"""
